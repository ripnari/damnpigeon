...
- Custom: hoodie only. 6 zones (hood, front, back, both sleeves, pocket). Cuffs + waistband fixed black rib.
  $350 base; 1–2 cloths included, 3–4 +$50, 5–6 +$100; denim +$60 each. XS–XXL. 4–6 weeks. Paid in full. Final sale.
  Seven cloths (Sept 16): black / grey / red fleece, cheetah, black silk, blue denim (+$60), black denim (+$60).
  Textures live in assets/swatches/*.jpg and render on the hoodie panels. To swap in a real photo of a
  cloth, replace the file with the same name (square, ~640px, seamless-ish works best).
